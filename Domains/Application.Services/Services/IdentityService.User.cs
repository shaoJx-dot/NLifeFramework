...
namespace Application.Services.Services
{
    public partial class IdentityService
    {
        ...
        /// 获取 用户信息查询数据集
        /// </summary>
        public IQueryable<SYS_User> Users
        {
        ...
        public bool CheckUserExists(Expression<Func<SYS_User, bool>> predicate, int id = 0)
        {
        ...
        public OperationResult AddUsers(params SYS_UserDto[] dtos)
        {
        ...
        /// <returns>业务操作结果</returns>
        public OperationResult EditUsers(params SYS_UserDto[] dtos)
        {
            throw new NotImplementedException();
        }
