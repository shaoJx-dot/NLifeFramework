...
namespace Component.Data.Utils
{
    public class DBUtils
    {
        ...
        public static IDBHelper GetDBHelper(DataBaseType dbType)
        {
            ...
            if (!_iDBHelpers.TryGetValue(dbType, out dbHelper))
            {
                ...
                {
                    case DataBaseType.SqlServer:
                        dbHelper = new Component.Data.SqlDBHelper.DBAdaptor();
                        break;
                    //case DataBaseType.MySql:
                    //    dbHelper = new Component.Data.MySqlDBHelper.MySqlAdaptor();
                    //    break;
                    //case DataBaseType.Oracle:
                    //dbHelper = new Component.Data.OracleDBHelper.OracleAdaptor();
                    //break;
                    default:
                        dbHelper = new Component.Data.SqlDBHelper.DBAdaptor();
                        break;
