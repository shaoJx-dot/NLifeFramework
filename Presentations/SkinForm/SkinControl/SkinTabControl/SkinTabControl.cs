...
namespace CCWin.SkinControl
{
    ...
    public class SkinTabControl : TabControl
    {
        ...
        #region 属性
        private Image btnArrowNorml = Properties.Resources.tab_dots_normal;
        [CategoryAttribute("btnArrow")]
        [Description("BtnArrow标签默认背景")]
        public Image BtnArrowNorml
        {
            get { return btnArrowNorml; }
            set
            {
                btnArrowNorml = value;
        ...
        private Image btnArrowHover = Properties.Resources.tab_dots_mouseover;
        [CategoryAttribute("btnArrow")]
        [Description("BtnArrow标签悬浮事背景")]
        public Image BtnArrowHover
        {
            get { return btnArrowHover; }
            set
            {
                btnArrowHover = value;
                base.Invalidate(true);
        ...
        private Image btnArrowDown = Properties.Resources.tab_dots_down;
        [CategoryAttribute("btnArrow")]
        [Description("BtnArrow标签按下时背景")]
        public Image BtnArrowDown
        {
            get { return btnArrowDown; }
            set
            {
                btnArrowDown = value;
                base.Invalidate(true);
        ...
        private Image pageNorml = Properties.Resources.tab_dots_normal;
        ...
        private Image pageHover = Properties.Resources.tab_dots_mouseover;
        [CategoryAttribute("Page")]
        [Description("Page标签悬浮事背景")]
        ...
        private Image pageDown = Properties.Resources.tab_dots_down;
        [CategoryAttribute("Page")]
                ...
                if (this.SelectedIndex == i)//是否选中
                {
                    ...
                    if (contextMenuStrip != null)
                    {
                        ...
                        if (tabRect.Contains(cursorPoint))
                        {
                            if (this._isFocus)
                            {
                                btnArrowImage = BtnArrowDown;
                                contextMenuStrip.Show(contextMenuLocation);
                            }
                            else
                            {
                                btnArrowImage = BtnArrowHover;
                            }
                        ...
                        {
                            btnArrowImage = BtnArrowNorml;
                        }
                    }
                }
                else if (tabRect.Contains(cursorPoint))//鼠标滑过
                {
                    baseTabHeaderImage = PageHover;
                }
                else 
                {
                    baseTabHeaderImage = PageNorml;
                }
