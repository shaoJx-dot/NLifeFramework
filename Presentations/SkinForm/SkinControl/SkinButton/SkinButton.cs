...
namespace CCWin.SkinControl
{
    ...
    public partial class SkinButton : Button
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            {
                this.FindForm().BackColorChanged += new EventHandler(SkinButton_BackColorChanged);
                if (InheritColor)
                    this.BaseColor = this.FindForm().BackColor;
            }
        }

        void SkinButton_BackColorChanged(object sender, EventArgs e)
        {
            if (InheritColor)
                this.BaseColor = (sender as Form).BackColor;
        }
