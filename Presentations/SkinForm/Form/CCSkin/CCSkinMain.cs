...
namespace CCWin
{
    public partial class CCSkinMain : Form
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            SetReion();
            if (this.Owner is CCSkinMain && InheritBack)
            {
            ...
            else if (this.Owner is Form && InheritBack)
            {
        ...
        private void WmNcHitTest(ref Message m)
        {
            ...
            if (!ControlBoxManager.CloseBoxRect.Contains(point) &&
                ...
                Mobile != MobileStyle.None)
            {
                if (Mobile == MobileStyle.TitleMobile && point.Y < CaptionHeight)
                {
                    m.Result = new IntPtr(
                      HITTEST.HTCAPTION);
                    return;
                }
                else if (Mobile == MobileStyle.Mobile)
                {
                    m.Result = new IntPtr(
                      HITTEST.HTCAPTION);
                    return;
        ...
        private void WmGetMinMaxInfo(ref Message m)
        {
            ...
            else
            {
                ...
                minmax.minTrackSize = new Size(
                    ...
                    MaxSize.Width + SysBottomSize.Width + ControlBoxOffset.X +
