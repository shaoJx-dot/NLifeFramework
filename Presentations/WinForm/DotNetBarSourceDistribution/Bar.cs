namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(Bar), "Bar.ico"), ToolboxItem(true), Designer("DevComponents.DotNetBar.Design.BarDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf"), System.Runtime.InteropServices.ComVisible(false), DefaultEvent("ItemClick")]
        ...
        ICustomSerialization, IRenderingSupport, IAccessibilitySupport, IOwnerLocalize
    {
        ...
        private void RefreshDockTabItems()
        {
            ...
            if (!m_TabDockItems.Visible && m_BarState != eBarState.AutoHide)
            {
                ...
                {
                    m_TabDockItems.Size = new Size(this.Width - 4, DockTabStripHeight);
                    m_TabDockItems.Location = new Point(2, this.Height - DockTabStripHeight - 2);
                }
            }
                    ...
                    case eTabStripAlignment.Top:
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    p = new Point(1, 1);
                                    sz = new Size(this.Width - 2, DockTabStripHeight);
                                }
                                else if (m_BarState == eBarState.Floating)
                                {
                                    if (this.IsThemed)
                                    ...
                                    {
                                        p = new Point(3, 3);
                                        sz = new Size(this.Width - 6, DockTabStripHeight);
                                    }
                                }
                                else
                                    m_TabDockItems.Visible = false;
                    ...
                    case eTabStripAlignment.Left:
                        {
                            if (m_GrabHandleStyle != eGrabHandleStyle.None && !m_GrabHandleRect.IsEmpty)
                            {
                                ...
                                sz = new Size(DockTabStripHeight, m_ItemContainer.HeightInternal - 1);
                            }
                            else
                            {
                                if (m_BarState == eBarState.Docked)
                                {
                                    p = new Point(2, 1);
                                    sz = new Size(DockTabStripHeight, this.Height - 3);
                                }
                                else if (m_BarState == eBarState.Floating)
                                {
                                    if (this.IsThemed)
                    ...
                    case eTabStripAlignment.Right:
                        {
                            ...
                            {
                                p = new Point(this.ClientRectangle.Right - DockTabStripHeight, m_GrabHandleRect.Bottom + 1);
                                sz = new Size(DockTabStripHeight - 2, m_ItemContainer.HeightInternal);
                            }
                            else
                            {
                                if (m_BarState == eBarState.Docked)
                                {
                                    p = new Point(this.Width - DockTabStripHeight, 1);
                                    sz = new Size(DockTabStripHeight, this.Height - 2);
                                }
                                else if (m_BarState == eBarState.Floating)
                                {
                                    if (this.IsThemed)
                                    ...
                                    {
                                        p = new Point(this.Width - 3 - DockTabStripHeight, m_ItemContainer.TopInternal);
                    ...
                    default:
                        {
                            ...
                            {
                                p = new Point(0, this.Height - DockTabStripHeight - 1);
                                sz = new Size(this.Width, DockTabStripHeight);
                            }
                            if (m_BarState == eBarState.Docked)
                            {
                                if (m_DockedBorder != eBorderType.None)
                                {
                                    p = new Point(2, this.Height - DockTabStripHeight - 3);
                                    sz = new Size(this.Width - 4, DockTabStripHeight);
                                }
                            }
                            else if (m_BarState == eBarState.Floating)
                            {
                                ...
                                {
                                    p = new Point(3, this.Height - DockTabStripHeight - 3);
                                    sz = new Size(this.Width - 6, DockTabStripHeight);
                                }
                            }
                            else
        ...
        protected override bool ProcessMnemonic(char charCode)
        {
            if (!this.MenuBar)
            {
			    ...
			    {
                    if (objItem.Visible && objItem.GetEnabled() && objItem.Displayed && objItem.AccessKey == charCode)
                    {
