...
namespace DevComponents.DotNetBar.Schedule
{
    public class WeekDayView : BaseView
    {
        ...
        private ColumnList GetColList(List<ColumnList> list, CalendarItem item)
        {
        ...
        private bool GetColListIndex(List<ColumnList> list, int id, out int index)
        {
        ...
        private void CalcAppointmentBounds(int col, List<ColumnList> list)
        {
