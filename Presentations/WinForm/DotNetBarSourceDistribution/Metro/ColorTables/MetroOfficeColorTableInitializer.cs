...
namespace DevComponents.DotNetBar.Metro.ColorTables
{
    internal static class MetroOfficeColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            // Magenta
            rt = GetRibbonTabItemBlueDefault(factory, metroColors, ribbonBack); 
            //rt.CornerSize = 2;
            ...
            table.LegacyColors.ItemText = factory.GetColor(metroColors.TextColor); // SystemColors.ControlTet;
        ...
        public static Office2007ButtonItemColorTable CreateBlueOrbColorTable(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            cb.MouseOver.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight));
            ...
            cb.MouseOverSplitInactive = new Office2007ButtonItemStateColorTable();
            cb.MouseOverSplitInactive.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight1));
            cb.MouseOverSplitInactive.Text = factory.GetColor(metroColors.BaseColorLightText);
        ...
        #region RangeSlider
        internal static void InitRangeSlider(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            Office2010RangeSliderColorTable rsl = table.RangeSlider;
            rsl.TickLineColor = factory.GetColor(metroColors.TextInactiveColor);

            rsl.RangeBackground = new GradientColorTable(factory.GetColor(metroColors.CanvasColorLightShade));
            rsl.RangeLineColor = factory.GetColor(metroColors.TextInactiveColor);
            rsl.RangeValueBackground = new GradientColorTable(factory.GetColor(metroColors.BaseColorLight));
            rsl.RangeValueLineColor = factory.GetColor(metroColors.BaseColor);
            rsl.RangeCornerRadius = 0;

            rsl.MinRangeSlider.Default.Background = new GradientColorTable(factory.GetColor(metroColors.BaseColor));
            rsl.MinRangeSlider.Default.BorderColor = factory.GetColor(metroColors.BaseColor);
            rsl.MinRangeSlider.Default.BorderLightColor = Color.Empty;
            rsl.MinRangeSlider.Disabled.Background = new GradientColorTable(factory.GetColor(metroColors.TextDisabledColor));
            rsl.MinRangeSlider.Disabled.BorderColor = metroColors.TextDisabledColor;
            rsl.MinRangeSlider.Disabled.BorderLightColor = Color.Empty;
            rsl.MinRangeSlider.MouseOver.Background = new GradientColorTable(factory.GetColor(metroColors.BaseColorDark));
            rsl.MinRangeSlider.MouseOver.BorderColor = metroColors.BaseColorDark;
            rsl.MinRangeSlider.MouseOver.BorderLightColor = Color.Empty;
            rsl.MinRangeSlider.Pressed.Background = rsl.MinRangeSlider.MouseOver.Background;
            rsl.MinRangeSlider.Pressed.BorderColor = rsl.MinRangeSlider.MouseOver.BorderColor;
            rsl.MinRangeSlider.Pressed.BorderLightColor = rsl.MinRangeSlider.MouseOver.BorderLightColor;
