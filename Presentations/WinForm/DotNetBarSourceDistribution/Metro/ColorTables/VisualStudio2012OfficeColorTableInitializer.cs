...
{
    internal class VisualStudio2012OfficeColorTableInitializer
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory, MetroPartColors metroColors)
        {
            // This was conflicting with buttons which used CanvasColorLight for on mouse over effect.
            //Color ribbonBack = factory.GetColor(metroColors.IsSolidCanvas ? metroColors.CanvasColor : metroColors.CanvasColorLight);
            Color ribbonBack = factory.GetColor(metroColors.CanvasColorLighterShade);
            ...
            table.RibbonControl.PanelTopBackground = new LinearGradientColorTable(ribbonBack);
            ...
            #region RibbonBar
            table.RibbonBar.Default = GetRibbonBar(factory, metroColors, ribbonBack);
            table.RibbonBar.MouseOver = GetRibbonBarMouseOver(factory, metroColors, ribbonBack);
            table.RibbonBar.Expanded = GetRibbonBarExpanded(factory, metroColors, ribbonBack);
            #endregion
            ...
            Office2007RibbonTabItemColorTable rt = GetRibbonTabItemBlueDefault(factory, metroColors, ribbonBack);
            rt.Name = Enum.GetName(typeof(eRibbonTabColor), eRibbonTabColor.Default);
            table.RibbonTabItemColors.Add(rt);

            // Magenta
            rt = GetRibbonTabItemBlueDefault(factory, metroColors, ribbonBack); //GetRibbonTabItemBlueMagenta(factory);
            //rt.CornerSize = 2;
            rt.Name = Enum.GetName(typeof(eRibbonTabColor), eRibbonTabColor.Magenta);
            table.RibbonTabItemColors.Add(rt);

            // Green
            rt = GetRibbonTabItemBlueDefault(factory, metroColors, ribbonBack); //GetRibbonTabItemBlueGreen(factory);
            //rt.CornerSize = 2;
            rt.Name = Enum.GetName(typeof(eRibbonTabColor), eRibbonTabColor.Green);
            table.RibbonTabItemColors.Add(rt);

            // Orange
            rt = GetRibbonTabItemBlueDefault(factory, metroColors, ribbonBack); //GetRibbonTabItemBlueOrange(factory);
            //rt.CornerSize = 2;
            ...
            table.Menu.Border = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLightShade), Color.Empty);
            ...
            #region ComboBox
            table.ComboBox.Default.Background = factory.GetColor(metroColors.EditControlBackColor);
            ...
            table.ComboBox.DefaultStandalone.Background = factory.GetColor(metroColors.EditControlBackColor);
            ...
            table.ComboBox.MouseOver.Background = factory.GetColor(metroColors.EditControlBackColor);
            table.ComboBox.MouseOver.Border = factory.GetColor(metroColors.CanvasColorDarkShade);
            table.ComboBox.MouseOver.ExpandBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.MouseOver.ExpandBorderInner = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.MouseOver.ExpandBorderOuter = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.MouseOver.ExpandText = factory.GetColor(metroColors.BaseTextColor);
            table.ComboBox.DroppedDown.Background = factory.GetColor(metroColors.EditControlBackColor);
            table.ComboBox.DroppedDown.Border = factory.GetColor(metroColors.CanvasColorDarkShade);
            table.ComboBox.DroppedDown.ExpandBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.DroppedDown.ExpandBorderInner = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.DroppedDown.ExpandBorderOuter = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            table.ComboBox.DroppedDown.ExpandText = factory.GetColor(metroColors.BaseTextColor);
            #endregion
            ...
            table.SystemButton.Default.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.TextColor));
            ...
            table.SystemButton.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight));
            table.SystemButton.MouseOver.BottomBackground = null;
            table.SystemButton.MouseOver.TopHighlight = null;
            table.SystemButton.MouseOver.BottomHighlight = null;
            ...
            table.SystemButton.Pressed.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseTextColor));
            table.SystemButton.Pressed.LightShade = Color.Empty;
            table.SystemButton.Pressed.DarkShade = Color.Empty;
            table.SystemButton.Pressed.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            ...
            table.SystemButtonClose.Default.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.TextColor));
            ...
            table.SystemButtonClose.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight));
            table.SystemButtonClose.MouseOver.BottomBackground = null;
            table.SystemButtonClose.MouseOver.TopHighlight = null;
            table.SystemButtonClose.MouseOver.BottomHighlight = null; 
            ...
            table.SystemButtonClose.Pressed.Foreground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseTextColor));
            table.SystemButtonClose.Pressed.LightShade = Color.Empty;
            table.SystemButtonClose.Pressed.DarkShade = Color.Empty;
            table.SystemButtonClose.Pressed.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor)); ;
            ...
            table.TabControl.Default.Text = factory.GetColor(metroColors.TextColor);

            table.TabControl.MouseOver = new Office2007TabItemStateColorTable();
            table.TabControl.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight1), Color.Empty);
            ...
            table.TabControl.MouseOver.Text = metroColors.BaseTextColor;

            table.TabControl.Selected = new Office2007TabItemStateColorTable();
            table.TabControl.Selected.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor), Color.Empty);
            ...
            table.TabControl.Selected.OuterBorder = factory.GetColor(metroColors.BaseColor);
            table.TabControl.Selected.Text = metroColors.BaseTextColor;
            ...
            #region Dock TabStrip Colors
            table.DockTabStrip = new Office2007TabColorTable();
            table.DockTabStrip.Default = new Office2007TabItemStateColorTable();
            table.DockTabStrip.Default.TopBackground = LinearGradientColorTable.Empty;
            table.DockTabStrip.Default.BottomBackground = LinearGradientColorTable.Empty;
            table.DockTabStrip.Default.InnerBorder = Color.Empty;
            table.DockTabStrip.Default.OuterBorder = Color.Empty;
            table.DockTabStrip.Default.Text = factory.GetColor(metroColors.TextColor);

            table.DockTabStrip.MouseOver = new Office2007TabItemStateColorTable();
            table.DockTabStrip.MouseOver.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight), Color.Empty);
            table.DockTabStrip.MouseOver.BottomBackground = LinearGradientColorTable.Empty;
            table.DockTabStrip.MouseOver.InnerBorder = Color.Empty;
            table.DockTabStrip.MouseOver.OuterBorder = Color.Empty;
            table.DockTabStrip.MouseOver.Text = metroColors.BaseColor;

            table.DockTabStrip.Selected = new Office2007TabItemStateColorTable();
            table.DockTabStrip.Selected.TopBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight), Color.Empty);
            table.DockTabStrip.Selected.BottomBackground = LinearGradientColorTable.Empty;
            table.DockTabStrip.Selected.InnerBorder = Color.Empty;
            table.DockTabStrip.Selected.OuterBorder = factory.GetColor(metroColors.CanvasColorLighterShade);
            table.DockTabStrip.Selected.Text = metroColors.BaseColor;

            table.DockTabStrip.TabBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColor));
            table.DockTabStrip.TabPanelBackground = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight), Color.Empty);
            table.DockTabStrip.TabPanelBorder = metroColors.CanvasColorLightShade;
            #endregion
            ...
            table.LegacyColors.BarCaptionBackground = factory.GetColor(metroColors.BaseColor);
            ...
            table.LegacyColors.BarCaptionText = factory.GetColor(metroColors.BaseTextColor);
            ...
            table.LegacyColors.ItemExpandedBorder = factory.GetColor(metroColors.CanvasColorLightShade);
            table.LegacyColors.ItemHotBackground = factory.GetColor(metroColors.CanvasColorLight);
            table.LegacyColors.ItemHotBackground2 = Color.Empty;
            table.LegacyColors.ItemHotBorder = factory.GetColor(metroColors.CanvasColorLight);
            table.LegacyColors.ItemHotText = factory.GetColor(metroColors.TextColor);
            table.LegacyColors.ItemPressedBackground = factory.GetColor(metroColors.BaseColor);
            table.LegacyColors.ItemPressedBackground2 = Color.Empty;
            table.LegacyColors.ItemPressedBorder = factory.GetColor(metroColors.BaseColor);
            table.LegacyColors.ItemPressedText = factory.GetColor(metroColors.BaseTextColor);
            ...
            table.LegacyColors.PanelBackground = factory.GetColor(metroColors.CanvasColor);
            table.LegacyColors.PanelBackground2 = Color.Empty;
            table.LegacyColors.PanelText = factory.GetColor(metroColors.TextColor);
            table.LegacyColors.PanelBorder = factory.GetColor(metroColors.CanvasColorLighterShade);
            table.LegacyColors.ExplorerBarBackground = factory.GetColor(metroColors.CanvasColorLight);
            ...
            table.LegacyColors.AutoHideTabBackground = factory.GetColor(metroColors.CanvasColor);
            table.LegacyColors.AutoHideTabText = factory.GetColor(metroColors.TextColor);
            table.LegacyColors.AutoHideTabBorder = factory.GetColor(metroColors.CanvasColorLightShade);
            table.LegacyColors.AutoHideSelectedTabBackground = factory.GetColor(metroColors.CanvasColor);
            table.LegacyColors.AutoHideSelectedTabBorder = factory.GetColor(metroColors.BaseColor);
            table.LegacyColors.AutoHideSelectedTabText = factory.GetColor(metroColors.BaseColor);
            ...
            #region SuperTooltip
            table.SuperTooltip.BackgroundColors = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColor));
            ...
            #region RangeSlider
            MetroOfficeColorTableInitializer.InitRangeSlider(table, factory, metroColors);
            #endregion
            ...
            table.ListViewEx.ColumnForeColor = factory.GetColor(metroColors.TextColor);
            ...
            sbt.SwitchBackColor = factory.GetColor(metroColors.BaseColor);
            sbt.SwitchOnBackColor = factory.GetColor(metroColors.CanvasColorLightShade);
            ...
            style.BackColor = factory.GetColor(metroColors.EditControlBackColor);
            ...
            table.LabelItemColors.Add(Office2007ColorTable.GetContextualKey(typeof(MetroStatusBar)), new LabelColors(factory.GetColor(metroColors.BaseTextColor), factory.GetColor(metroColors.TextDisabledColor)));
            table.LabelItemColors.Add(Office2007ColorTable.GetContextualKey(typeof(Bar)), new LabelColors(factory.GetColor(metroColors.BaseTextColor), factory.GetColor(metroColors.TextDisabledColor)));
            #endregion
        ...
        internal static Office2007ButtonItemColorTable GetAppFallBackColorTable()
        {
            ...
            MetroPartColors metroColors = VisualStudio2012ColorTableInitializer.CreateMetroPartColors(MetroColorGeneratorParameters.Default.CanvasColor, MetroColorGeneratorParameters.Default.BaseColor);
            // Blue default
        ...
        internal static void InitAppButtonColors(Office2007ColorTable colorTable, ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            table.Expanded = table.MouseOver;
            table.Checked = table.Pressed;
        ...
        #region RibbonBar
        public static Office2007RibbonBarStateColorTable GetRibbonBar(ColorFactory factory, MetroPartColors metroColors, Color ribbonBack)
        {
            ...
            rb.TopBackground = new LinearGradientColorTable(ribbonBack);
        ...
        public static Office2007RibbonBarStateColorTable GetRibbonBarMouseOver(ColorFactory factory, MetroPartColors metroColors, Color ribbonBack)
        {
            return GetRibbonBar(factory, metroColors, ribbonBack);
            //Office2007RibbonBarStateColorTable rb = new Office2007RibbonBarStateColorTable();
            //rb.TopBackgroundHeight = 0.8f;
        ...
        public static Office2007RibbonBarStateColorTable GetRibbonBarExpanded(ColorFactory factory, MetroPartColors metroColors, Color ribbonBack)
        {
            Office2007RibbonBarStateColorTable rb = new Office2007RibbonBarStateColorTable();
        ...
        public static Office2007ButtonItemColorTable GetButtonItemDefault(ColorFactory factory, MetroPartColors metroColors)
        {
            ...
            cb.MouseOver.BottomBackground = null;
            cb.MouseOver.BottomBackgroundHighlight = null;
            cb.MouseOver.Background = new LinearGradientColorTable(metroColors.CanvasColorLight);
            cb.MouseOver.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight));// LinearGradientColorTable.Empty;
            cb.MouseOver.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColorLight));
            ...
            cb.MouseOverSplitInactive = new Office2007ButtonItemStateColorTable();
            cb.MouseOverSplitInactive.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.CanvasColor));

            // Pressed
            cb.Pressed = new Office2007ButtonItemStateColorTable();
            cb.Pressed.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            cb.Pressed.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            ...
            cb.Checked.OuterBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight));
            cb.Checked.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight));
            cb.Checked.Background = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColorLight));
            ...
            cb.Expanded.InnerBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
            ...
            cb.Expanded.SplitBorder = new LinearGradientColorTable(factory.GetColor(metroColors.BaseColor));
        ...
        public static Office2007RibbonTabItemColorTable GetRibbonTabItemBlueDefault(ColorFactory factory, MetroPartColors metroColors, Color ribbonBack)
        {
            ...
            rt.Selected.Background = new LinearGradientColorTable(ribbonBack);
            ...
            rt.SelectedMouseOver.Background = new LinearGradientColorTable(ribbonBack);
        ...
        public static void InitializeScrollBarColorTable(Office2007ScrollBarColorTable scrollBarColorTable, ColorFactory factory, MetroPartColors metroParts)
        {
            ...
            sct.Background = new LinearGradientColorTable(factory.GetColor(metroParts.CanvasColorLight));
