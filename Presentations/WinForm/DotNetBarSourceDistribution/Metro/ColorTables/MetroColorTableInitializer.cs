    ...
    internal class MetroColorTableInitializer
    {
        ...
        public static MetroPartColors CreateMetroPartColors(Color canvasColor, Color baseColor)
        {
            ...
            if(partColors.IsSolidCanvas)
                ...
                partColors.CanvasColorLight = (partColors.TextColor == Color.Black) ? ColorHelpers.HSVToColor(canvasHsv.Hue, canvasHsv.Saturation, canvasHsv.Value + .055) : ColorHelpers.HSVToColor(canvasHsv.Hue, canvasHsv.Saturation, canvasHsv.Value - .05);
