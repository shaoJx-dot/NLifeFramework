                ...
                using (StringFormat format = new StringFormat(StringFormat.GenericTypographic))
                {
                    ...
                    if (m_TrailingSpace)
                    {
                        if (d.CurrentFont.Italic)
                        {
                            ...
                            if (PadText)
                            {
                                size.Width += TextHelper.TextMarkupCultureSpecificPadding;
                                size.Height += TextHelper.TextMarkupCultureSpecificPadding;
                            }
                            this.Bounds = new Rectangle(Point.Empty, size);
                        }
                        else
