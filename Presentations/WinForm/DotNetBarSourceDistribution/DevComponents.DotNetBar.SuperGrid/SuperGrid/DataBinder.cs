                ...
                if (_BindingSource != null)
                {
                    ...
                    if (bs != null)
                    {
                        ...
                        while (bs.DataSource is BindingSource)
                            bs = (BindingSource)_BindingSource.DataSource;
                ...
                if (_Pdc != null)
                {
                    if (_Panel.AutoGenerateColumns == true)
                    {
                        if (_BaseDataSource is DataTable)
                            AutoGenerateColumns((DataTable)_BaseDataSource);
                        else
                            AutoGenerateColumns();
                    }
                ...
                if (row != null)
                {
                    ...
                    if (view != null)
                    {
                        ...
                        foreach (DataRelation dr in dt.ChildRelations)
                            CreateNestedPanel(_Panel, row, dr, sb);
                    }
                }
            }
        }
                    ...
                    else
                    {
                        ...
                        if (_Panel.AutoSelectDeleteBoundRows == true)
                        {
                            ...
                            if ((uint)index < cont.Rows.Count)
                            {
                                ...
                                CurrencyManager.Position = ((GridRow)cont.Rows[index]).DataItemIndex;
                            }
                        }
                        else
                        {
                ...
                if (col.ColumnIndex < row.Cells.Count)
                {
                    ...
                    if (pd != null)
                    {
                        ...
                        if (_Panel.KeepRowsSorted == true)
                        {
                            ...
                            {
                                if (CompareVal.CompareTo(value, value2) != 0)
                                {
