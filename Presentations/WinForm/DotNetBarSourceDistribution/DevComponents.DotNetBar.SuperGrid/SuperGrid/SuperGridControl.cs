...
namespace DevComponents.DotNetBar.SuperGrid
{
    ...
    [Designer("DevComponents.SuperGrid.Design.SuperGridDesigner, DevComponents.SuperGrid.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=26d81176cfa2b486")]
    public class SuperGridControl : Control, INotifyPropertyChanged, IMessageFilter, IOwnerLocalize
    {
        ...
        public event EventHandler<GridGroupChangedEventArgs> GroupChanged;
        ...
        public event EventHandler<GridVirtualRowEventArgs> VirtualRowLoaded;
        ...
        public GridContainer ActiveRow
        {
            ...
            internal set
            {
                if (_ActiveRow != value)
                {
                    ...
                    else if (_ActiveGrid != null)
                        _ActiveGrid.ActiveRow = null;
        ...
        /// Performs grid layout.
        /// </summary>
        ///<param name="force">Whenther to force operation even if layout is valid.</param>
        ...
        private void _VScrollBar_SizeChanged(object sender, EventArgs e)
        {
            _PrimaryGrid.InvalidateLayout();
        }

        private void _HScrollBar_SizeChanged(object sender, EventArgs e)
        {
            _PrimaryGrid.InvalidateLayout();
        }
