...
namespace DevComponents.DotNetBar.SuperGrid
{
    ...
    public class GridCell : GridElement, IComparable<GridCell>, IDisposable
    {
        ...
        internal bool CanModify
        {
            get
            {
                if (Visible == false ||
                    ...
                    AllowEdit == false || GridColumn.AllowEdit == false || GridRow.AllowEdit == false || GridPanel.AllowEdit == false ||
                    AllowSelection == false || GridColumn.AllowSelection == false || GridRow.AllowSelection == false || GridPanel.AllowSelection == false)
                {
                    return (false);
                }
        ...
        [Editor("DevComponents.SuperGrid.Design.EditTypeEditor, DevComponents.SuperGrid.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=26d81176cfa2b486", typeof(UITypeEditor))]
        ...
        [Editor("DevComponents.SuperGrid.Design.ValueTypeEditor, DevComponents.SuperGrid.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=26d81176cfa2b486", typeof(UITypeEditor))]
        public object Value
        {
            get
            {
        ...
        protected virtual void SetValue(object value)
        {
            ...
            if (panel != null)
            {
                ...
                if (row.Loading == false)
                {
                    ...
                    if (GridColumn.IsGroupColumn == true)
                    {
                ...
                if (editor != null)
                {
                    ...
                    try
                    {
                        ...
                        if (editor.CellEditMode == CellEditMode.Modal)
                        {
                            ...
                            size = GetModalSize(g, s, style, constraintSize);

                            if (actual == false)
                            {
                                Size size2 = editor.GetProposedSize(g, this, style, constraintSize);
            ...
            if (SuperGrid.ActiveEditor == null)
            {
                ...
                if (IsEmptyCell == false)
                {
                    ...
                    if (CellEditMode != CellEditMode.Modal)
                        _mouseRenderer = GetInternalEditControl();
                    
                    if (_mouseRenderer == null)
                        _mouseRenderer = GetInternalRenderControl();
                ...
                if (_toolTipText == null)
                {
                        ...
                        ((Control)_mouseRenderer).IsDisposed == false)
                    {
                        ...
                        if (size.Width > r.Width || size.Height > r.Height)
                            _toolTipText = GetFormattedValue(_mouseRenderer);
                    }
                }
            }
        ...
        public IGridCellEditControl BeginEdit(bool selectAll, KeyEventArgs e)
        {
            ...
            if (Visible == true && CanModify == true)
            {
                ...
                {
                    if (CanSetActiveCell(GridPanel, this) == true)
                    {
