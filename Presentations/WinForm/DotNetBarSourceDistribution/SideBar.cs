...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [ToolboxItem(true), System.Runtime.InteropServices.ComVisible(false), Designer("DevComponents.DotNetBar.Design.SideBarDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
...
//				EventMouseMove(this,e);
        ...
        {
            SideBarPanelItem expanded = this.ExpandedPanel;
            if (expanded != null)
                expanded.OnMouseWheel(e);
            base.OnMouseWheel(e);
        }
...
//			}
		...
		/// </summary>
        [System.ComponentModel.Editor("DevComponents.DotNetBar.Design.SideBarPanelsEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.ComponentModel.Category("Data"), System.ComponentModel.Description("Returns the collection of side-bar Panels.")]
...
//			return false;
        ...
        bool IMessageHandlerClient.OnMouseWheel(IntPtr hWnd, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                SideBarPanelItem expanded = this.ExpandedPanel;
                if (expanded != null && expanded.HasScrollButtons)
                {
                    expanded.OnMouseWheel(new MouseEventArgs(Control.MouseButtons, 0, p.X, p.Y, (wParam.ToInt64() > 0 ? -1 : 1)));
                }
            }
            return false;
        }
