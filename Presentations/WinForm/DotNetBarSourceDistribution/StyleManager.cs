...
namespace DevComponents.DotNetBar
{
    ...
    public class StyleManager : Component
    {
        ...
        /// </summary>
        [Editor("DevComponents.DotNetBar.Design.Metro.MetroColorThemeEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
        ...
        private static eDotNetBarStyle DotNetBarStyleFromStyle(eStyle value)
        {
            ...
            else if (value == eStyle.Metro || StyleManager.IsVisualStudio2012(value))
        ...
        public static bool IsMetro(eDotNetBarStyle style)
        {
            ...
            return style == eDotNetBarStyle.Metro;
        }
        ...
        {
            return style == eStyle.Metro || StyleManager.IsVisualStudio2012(style);
        }
