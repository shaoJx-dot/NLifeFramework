...
{
    internal class RichTextBoxScrollEx : RichTextBox, IScrollBarOverrideSupport
    {
        ...
        //private static Array _EnumValues = Enum.GetValues(typeof(WM));
        //private object MapMessage(int msg)
        //{
        //    foreach (object item in _EnumValues)
        //    {
        //        if (item != null && (uint)item == msg)
