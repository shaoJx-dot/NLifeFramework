...
{
    [ToolboxBitmap(typeof(GroupPanel), "Controls.GroupPanel.ico"), ToolboxItem(true), Designer("DevComponents.DotNetBar.Design.GroupPanelDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
    public class GroupPanel : PanelControl, INonClientControl
    {
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            if (IsHandleCreated) InvalidateNonClient();
