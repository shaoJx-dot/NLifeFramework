...
{
#if FRAMEWORK20
    [Designer("DevComponents.DotNetBar.Design.LabelXDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
#endif
    ...
    public class LabelX : BaseItemControl, ICommandSource
    {
        ...
        /// </summary>
        [Browsable(true), Editor("DevComponents.DotNetBar.Design.TextMarkupUIEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), Category("Appearance"), Description("The text contained in the item.")]
        ...
        {
            if (!m_PreferredSize.IsEmpty && (proposedSize.Width == m_PreferredSize.Width || proposedSize.Width == 0)) return m_PreferredSize;
            ...
            else
            {
                ...
                {
                    m_Label.Height = 0;
                    m_Label.Width = proposedSize.Width;
                    m_Label.RecalcSize();
                }
            }
            Size s = m_Label.Size;
