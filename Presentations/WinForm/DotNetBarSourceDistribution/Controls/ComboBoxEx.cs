...
namespace DevComponents.DotNetBar.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(ComboBoxEx), "Controls.ComboBoxEx.ico"), ToolboxItem(true), Designer("DevComponents.DotNetBar.Design.ComboBoxExDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
    public class ComboBoxEx : System.Windows.Forms.ComboBox, ICommandSource
    {
        ...
        protected virtual void DrawComboItem(DrawItemEventArgs e)
        {
            ...
            if ((e.State & DrawItemState.Selected) != 0 || (e.State & DrawItemState.HotLight) != 0)
            {
                ...
                if (BarFunctions.IsOffice2007Style(m_Style))
                    Office2007ButtonItemPainter.PaintBackground(g, ct, backBounds, RoundRectangleShapeDescriptor.RoundCorner2);
                else
                    e.DrawBackground();
                DrawFocusRectangle(e);
            }
        ...
        [System.ComponentModel.Editor("DevComponents.DotNetBar.Design.ComboItemsEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), Localizable(true)]
        ...
        [Editor("DevComponents.DotNetBar.Design.ColumnNamesEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
        [TypeConverter("DevComponents.DotNetBar.Design.ColumnNamesConverter, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
        ...
        {
            if (_DroppedDown && (e.Action != eTreeAction.Code))
            {
