...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class Office2010BlueFactory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            int editBorderColor = 0x849DBD;
            table.RibbonControl.OuterBorder = new LinearGradientColorTable(factory.GetColor(0x728EAD), factory.GetColor(editBorderColor));
            table.RibbonControl.InnerBorder = null; // new LinearGradientColorTable(factory.GetColor(0xEFF6FD), factory.GetColor(0xD8E4F2));
            ...
            table.Bar.ToolbarBottomBorder = factory.GetColor(editBorderColor);
            ...
            table.Bar.StatusBarTopBorder = factory.GetColor(editBorderColor);
            ...
            table.TabControl.Selected.OuterBorder = factory.GetColor(editBorderColor);
            ...
            table.LegacyColors.BarFloatingBorder = factory.GetColor(editBorderColor);
            ...
            table.LegacyColors.BarDockedBorder = factory.GetColor(editBorderColor);
            ...
            table.LegacyColors.PanelBorder = factory.GetColor(0x5D6C7A);
            ...
            table.NavigationPane.ButtonBackground.Colors.Add(new BackgroundColorBlend(factory.GetColor(0xCFDDEE), 0));
            #endregion
            ...
            table.ListViewEx.ColumnForeColor = factory.GetColor(0x1E395B);
            ...
            table.RadialMenu.RadialMenuBorder = factory.GetColor(0x60676E);
            table.RadialMenu.RadialMenuButtonBackground = factory.GetColor(0xFFFFFF);
            table.RadialMenu.RadialMenuButtonBorder = factory.GetColor(0x60676E);
            ...
            table.RadialMenu.RadialMenuItemForeground = factory.GetColor(0x60676E);
            table.RadialMenu.RadialMenuItemMouseOverBackground = Color.FromArgb(72, table.RadialMenu.RadialMenuItemForeground);
            table.RadialMenu.RadialMenuItemMouseOverForeground = factory.GetColor(0x60676E);
