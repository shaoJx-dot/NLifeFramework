...
namespace DevComponents.DotNetBar.Rendering
{
    ...
    public class Windows7BlueFactory
    {
        public static void InitializeBlueColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.RibbonControl.InnerBorder = null; // new LinearGradientColorTable(factory.GetColor(0xFBFDFF), factory.GetColor(0xE5F0FB));
            ...
            int editBorderColor = 0x8492A6;
            table.Bar.PopupToolbarBorder = factory.GetColor(editBorderColor);
            ...
            table.Menu.Border = new LinearGradientColorTable(factory.GetColor(editBorderColor), Color.Empty);
            ...
            table.LegacyColors.BarPopupBorder = factory.GetColor(editBorderColor);
            ...
            table.LegacyColors.MenuBorder = factory.GetColor(editBorderColor);
            ...
            table.LegacyColors.PanelBackground = factory.GetColor(0xF7FBFF);
            ...
            table.ListViewEx.ColumnForeColor = factory.GetColor(0x254264);
