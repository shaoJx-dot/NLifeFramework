...
namespace DevComponents.DotNetBar.Rendering
{
    internal class Office2007ColorTableFactory
    {
        ...
        public static void InitializeVistaBlackColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.ListViewEx.ColumnForeColor = factory.GetColor(0x000000);
        ...
        public static ElementStyle GetRichTextBoxStyle(Color borderColor)
        {
            ElementStyle style = new ElementStyle();
            style.Class = ElementStyleClassKeys.RichTextBoxBorderKey;
            style.BorderColor = borderColor;
            style.BorderWidth = 1;
            style.Border = eStyleBorderType.Solid;
            return style;
        ...
        public static ElementStyle GetItemPanelStyle(Color borderColor, Color backColor)
        {
            ElementStyle style = new ElementStyle();
        ...
        public static ElementStyle GetMetroTilePanelStyle(Color backColor)
        {
            ElementStyle style = new ElementStyle();
            style.Class = ElementStyleClassKeys.MetroTilePanelKey;
        ...
        public static ElementStyle GetMetroTileGroupStyle(Color textColor)
        {
            ElementStyle style = new ElementStyle();
            style.Class = ElementStyleClassKeys.MetroTileGroupTitleKey;
            style.TextColor = textColor;
            style.Font = new System.Drawing.Font("Segoe UI Semibold", 27.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            return style;
        }

        public static ElementStyle GetItemPanelStyle(Color borderColor)
        {
            return GetItemPanelStyle(borderColor, Color.White);
        }
        public static ElementStyle GetAdvTreeStyle(Color borderColor, Color backColor)
        {
            ElementStyle style = new ElementStyle();
        ...
        public static ElementStyle GetDateTimeInputBackgroundStyle(Color borderColor, Color backColor)
        {
            ElementStyle style = new ElementStyle();
        ...
        public static ElementStyle GetSlideOutButtonStyle(Color backColor)
        {
        ...
        public static ElementStyle GetMonthCalendarStyle(Color backColor)
        {
            ElementStyle style = new ElementStyle(ElementStyleClassKeys.MonthCalendarAdvKey);
            style.BackColor = backColor;
            style.Border = DevComponents.DotNetBar.eStyleBorderType.Solid;
            style.BorderColorSchemePart = DevComponents.DotNetBar.eColorSchemePart.PanelBorder;
            style.BorderWidth = 1;
            return style;
        }
        #endregion
