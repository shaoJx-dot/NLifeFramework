...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class Office2010BlackFactory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.ContextualTables.Add(Office2007ColorTable.GetContextualKey(typeof(Office2007ButtonItemColorTable), "StatusBar"), 
                GetButtonItemStatusBar(factory));
            #endregion
            ...
            #region Slider
            table.Slider = GetSliderTable(factory);
            table.ContextualTables.Add(Office2007ColorTable.GetContextualKey(typeof(Office2007SliderColorTable), typeof(Bar)) + "+StatusBar",
                GetSliderTableStatusBar(factory));
            #endregion
            ...
            table.LabelItemColors.Add(string.Empty, new LabelColors(factory.GetColor(0x000000), factory.GetColor(0x8D8D8D)));
            table.LabelItemColors.Add(Office2007ColorTable.GetContextualKey(typeof(Bar), "StatusBar"), new LabelColors(factory.GetColor(0xFFFFFF), factory.GetColor(0x8D8D8D)));
            #endregion
        ...
        public static Office2007ButtonItemColorTable GetButtonItemStatusBar(ColorFactory factory)
        {
            Office2007ButtonItemColorTable table = GetButtonItemBlueOrange(factory);
        ...
        #region Slider
        private static Office2007SliderColorTable GetSliderTableStatusBar(ColorFactory factory)
        {
            Office2007SliderColorTable sl = GetSliderTable(factory);
        ...
        private static Office2007SliderColorTable GetSliderTable(ColorFactory factory)
        {
            Office2007SliderColorTable sl = new Office2007SliderColorTable();
