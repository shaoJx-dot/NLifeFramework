							...
							switch(m_Orientation)
							{
								case eOrientation.Horizontal:
								{
									...
									else if(bDisplayed)
									{
                                        ...
                                        if (OverflowEnabled && (iX + objItem.WidthInternal + itemSpacing > m_Rect.Right - m_PaddingRight && iX > m_PaddingLeft + m_Rect.Left || (iX + objItem.WidthInternal + itemSpacing + DisplayMoreItem.FixedSize > m_Rect.Right && iCurrentItem + 1 < m_SubItems.Count && iVisible < iVisibleCount)))
										{
											if(iCurrentItem==0)
