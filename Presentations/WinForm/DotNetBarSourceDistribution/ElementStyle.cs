...
#endif
{
	...
	public class ElementStyle:System.ComponentModel.IComponent
	{
        ...
        public ElementStyle(string styleClass)
        {
            m_Class = styleClass;
        }
        /// <summary>Creates new instance of the class.</summary>
        public ElementStyle(Color textColor)
        {
            m_BackColorBlend.Parent = this;
            TextColor = textColor;
        }
        ...
        /// <summary>Creates new instance of the class.</summary>
        public ElementStyle(Color textColor, Color backColor)
        {
            m_BackColorBlend.Parent = this;
            TextColor = textColor;
            BackColor = backColor;
        ...
        /// <summary>Creates new instance of the class.</summary>
        public ElementStyle(Color textColor, Color backColor1, Color backColor2)
        {
            m_BackColorBlend.Parent = this;
            TextColor = textColor;
		...
		/// </summary>
		[DevCoSerialize(),Browsable(true),Category("Background"),Description("Gets or sets the background color for UI element."),Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)),TypeConverter("DevComponents.DotNetBar.Design.ColorSchemeColorConverter, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Background"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Gets or sets the target gradient background color for UI element."), TypeConverter("DevComponents.DotNetBar.Design.ColorSchemeColorConverter, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
		...
		/// </summary>
        [DevCoSerialize(), Browsable(true), Category("Text Properties"), Editor(typeof(ColorTypeEditor), typeof(System.Drawing.Design.UITypeEditor)), Description("Gets or sets the text color displayed in this UI element."), TypeConverter("DevComponents.DotNetBar.Design.ColorSchemeColorConverter, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
...
//		}
        ...
        /// </summary>
        [DevCoSerialize(), Browsable(true), Category("Design"), Description("Indicates the class style belongs to."), Localizable(false), DefaultValue("")]
#if DOTNETBAR
        [Editor("DevComponents.DotNetBar.Design.ElementStyleClassTypeEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
#endif
        public string Class
        {
            get { return m_Class; }
		...
		#region Methods
        internal bool _DisposeBackgroundImage = false;
		/// <summary>
		...
		public virtual void Dispose()
		{
            ...
            if (BarUtilities.DisposeItemImages && !this.DesignMode || _DisposeBackgroundImage)
            {
...
//				this.TextFormat=style.TextFormat;
            ...
            if (style.BackColorBlend.Count > 0)
            {
                ...
                this.BackColorBlend.Clear();
            if (style.GetColorScheme() != null)
                this.SetColorScheme(style.GetColorScheme());
		}
...
//#if AdvTree
				if (this.MaximumWidth!=0)
					return true;
                if (!string.IsNullOrEmpty(this.Class)) return true;
//#endif
                return false;
            }
        }
		...
		public ElementStyle Copy()
		{
            ...
            if (this.BackgroundImage != null)
            {
                ...
                style._DisposeBackgroundImage = true;
            }
