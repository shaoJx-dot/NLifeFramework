...
namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(ItemPanel), "Ribbon.ItemPanel.ico"), ToolboxItem(true), Designer("DevComponents.DotNetBar.Design.ItemPanelDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf"), System.Runtime.InteropServices.ComVisible(false)]
    public class ItemPanel : ItemControl, IScrollableItemControl, IBindingSupport
    {
        ...
        public void EnsureVisible(BaseItem item)
        {
            ...
            if ((r.X < bounds.X || r.Right > bounds.Height))
            {
                if (r.Y < 0)
                    p = new Point(Math.Abs(this.AutoScrollPosition.X - r.X) - 2, p.Y);
                else
                    p = new Point((r.Right + SystemInformation.HorizontalScrollBarHeight + 2) - (this.AutoScrollPosition.X + this.ClientRectangle.Width), p.Y);
            }
        ...
        /// </summary>
        [Browsable(true), DefaultValue(null), Editor("DevComponents.DotNetBar.Design.ItemSelectorTypeEditor, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
