...
namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [Browsable(false), Designer("DevComponents.DotNetBar.Design.SimpleItemDesigner, DevComponents.DotNetBar.Design, Version=11.4.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
    public class RangeSliderItem : BaseItem
    {
        ...
        {
            Size buttonSize = _RangeButtonSize;
            ...
            if (_SliderOrientation == eOrientation.Horizontal)
            {
                ...
                if (_TicksPosition == eTicksPosition.Top)
                {
                    _RangeButtonMinBounds = new Rectangle(0,
                                       _TicksHeight + _TicksRangeButtonSpacing + Math.Max(0, (itemHeight - (_TicksHeight + buttonSize.Height + _TicksRangeButtonSpacing)) / 2),
                                       buttonSize.Width,
                                       buttonSize.Height);
                }
                ...
                {
                    _RangeButtonMinBounds = new Rectangle(0,
                                       Math.Max(0, (itemHeight - (_TicksHeight + buttonSize.Height + _TicksRangeButtonSpacing)) / 2),
                                       buttonSize.Width,
                                       buttonSize.Height);
                }
                ...
                {
                    _RangeButtonMinBounds = new Rectangle(0,
                                       _TicksHeight + _TicksRangeButtonSpacing + (itemHeight - (_TicksHeight * 2 + buttonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       buttonSize.Width,
                                       buttonSize.Height);
                }
                ...
                int xstep = GetXStep(_TicksBounds.Width, minmax.Min, minmax.Max, _TicksStep);

                _RangeButtonMinBounds.X = _TicksBounds.X + ((Math.Abs(value.Min - minmax.Min)/_TicksStep) * xstep) - buttonSize.Width;
                _RangeButtonMaxBounds.X = _TicksBounds.X + ((Math.Abs((value.Max - minmax.Min)/_TicksStep)) * xstep);
            }
            else
            {
                ...
                if (_TicksPosition == eTicksPosition.Top)
                {
                    _RangeButtonMinBounds = new Rectangle(_TicksHeight + _TicksRangeButtonSpacing + Math.Max(0, (itemWidth - (_TicksHeight + buttonSize.Height + _TicksRangeButtonSpacing)) / 2),
                                       0,
                                       buttonSize.Height,
                                       buttonSize.Width);
                }
                ...
                {
                    _RangeButtonMinBounds = new Rectangle(Math.Max(0, (itemWidth - (_TicksHeight + buttonSize.Height + _TicksRangeButtonSpacing)) / 2),
                                       0,
                                       buttonSize.Height,
                                       buttonSize.Width);
                }
                ...
                {
                    _RangeButtonMinBounds = new Rectangle(_TicksHeight + _TicksRangeButtonSpacing + (itemWidth - (_TicksHeight * 2 + buttonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       0,
                                       buttonSize.Height,
                                       buttonSize.Width);
                }
                ...
                RangeValue minmax = GetNormalizedMinMaxValues();
                RangeValue value = GetNormalizedRangeValue();
                int ystep = GetXStep(_TicksBounds.Height, minmax.Min, minmax.Max, _TicksStep);

                _RangeButtonMinBounds.Y = _TicksBounds.Y + ((Math.Abs(value.Min - minmax.Min) / _TicksStep) * ystep) - buttonSize.Width;
                _RangeButtonMaxBounds.Y = _TicksBounds.Y + ((Math.Abs((value.Max - minmax.Min) / _TicksStep)) * ystep);
            }
        }
        ...
        private void UpdateTicksBounds()
        {
            ...
            if (_SliderOrientation == eOrientation.Horizontal)
            {
                if (_TicksPosition == eTicksPosition.Top)
                {
                    _TicksBounds = new Rectangle(_RangeButtonSize.Width,
                                       (m_Rect.Height - (_TicksHeight + _RangeButtonSize.Height + _TicksRangeButtonSpacing)) / 2,
                                       m_Rect.Width - _RangeButtonSize.Width * 2,
                                       _TicksHeight);
                }
                else if (_TicksPosition == eTicksPosition.Bottom)
                {
                    _TicksBounds = new Rectangle(_RangeButtonSize.Width,
                                       _RangeButtonSize.Height + _TicksRangeButtonSpacing + (m_Rect.Height - (_TicksHeight + _RangeButtonSize.Height + _TicksRangeButtonSpacing)) / 2,
                                       m_Rect.Width - _RangeButtonSize.Width * 2,
                                       _TicksHeight);
                }
                else if (_TicksPosition == eTicksPosition.TopAndBottom)
                {
                    _TicksBounds = new Rectangle(_RangeButtonSize.Width,
                                       (m_Rect.Height - (_TicksHeight * 2 + _RangeButtonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       m_Rect.Width - _RangeButtonSize.Width * 2,
                                       _TicksHeight);
                    _TicksBounds2 = new Rectangle(_RangeButtonSize.Width,
                                       _RangeButtonSize.Height + _TicksHeight + _TicksRangeButtonSpacing * 2 + (m_Rect.Height - (_TicksHeight * 2 + _RangeButtonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       m_Rect.Width - _RangeButtonSize.Width * 2,
                                       _TicksHeight);
                }
            }
            else
            {
                if (_TicksPosition == eTicksPosition.Top)
                {
                    _TicksBounds = new Rectangle((m_Rect.Width - (_TicksHeight + _RangeButtonSize.Height + _TicksRangeButtonSpacing)) / 2,
                                       _RangeButtonSize.Width,
                                       _TicksHeight,
                                       m_Rect.Height - _RangeButtonSize.Width * 2);
                }
                else if (_TicksPosition == eTicksPosition.Bottom)
                {
                    _TicksBounds = new Rectangle(_RangeButtonSize.Height + _TicksRangeButtonSpacing + (m_Rect.Width - (_TicksHeight + _RangeButtonSize.Height + _TicksRangeButtonSpacing)) / 2,
                                       _RangeButtonSize.Width,
                                       _TicksHeight,
                                       m_Rect.Height - _RangeButtonSize.Width * 2);
                }
                ...
                {
                    _TicksBounds = new Rectangle((m_Rect.Width - (_TicksHeight * 2 + _RangeButtonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       _RangeButtonSize.Width,
                                       _TicksHeight,
                                       m_Rect.Height - _RangeButtonSize.Width * 2);
                    _TicksBounds2 = new Rectangle(_RangeButtonSize.Height + _TicksHeight + _TicksRangeButtonSpacing * 2 + (m_Rect.Width - (_TicksHeight * 2 + _RangeButtonSize.Height + _TicksRangeButtonSpacing * 2)) / 2,
                                       _RangeButtonSize.Width,
                                       _TicksHeight,
                                       m_Rect.Height - _RangeButtonSize.Width * 2);
                }
        ...
        internal static int GetXStep(int ticksBoundsWidth, int min, int max, int tickSteps)
        {
            int xstep = Math.Max(1, ticksBoundsWidth / (Math.Abs(max - min) / tickSteps));
            return xstep;
        }
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left && !this.DesignMode)
            {
                ...
                if (MouseDownPart == eRangeSliderPart.TickArea && _ClientClickRangeChangeEnabled)
                {
                    ...
                    if (_SliderOrientation == eOrientation.Horizontal)
                    {
                        ...
                        v = minmax.Min + (x / GetXStep(_TicksBounds.Width, minmax.Min, minmax.Max, _TicksStep)) * _TicksStep;
                    }
                    else
                    {
                        int y = e.Y - (_TicksBounds.Y + this.Bounds.Y);
                        v = minmax.Min + (y / GetXStep(_TicksBounds.Height, minmax.Min, minmax.Max, _TicksStep)) * _TicksStep;
                    }
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left && !this.DesignMode)
            {
                if (_MouseDownPart == eRangeSliderPart.MinRangeSlider)
                {
                    if (_SliderOrientation == eOrientation.Horizontal)
                    {
                        ...
                        RangeValue minmax = GetNormalizedMinMaxValues();
                        int xStep = GetXStep(_TicksBounds.Width, minmax.Min, minmax.Max, _TicksStep);
                        int v = minmax.Min + (x / xStep) * _TicksStep;
                        if (v > this.Value.Max)
                            v = this.Value.Max;
                        if (v < minmax.Min)
                            v = minmax.Min;
                    ...
                    else
                    {
                        int y = e.Y - (_TicksBounds.Y + this.Bounds.Y);
                        RangeValue minmax = GetNormalizedMinMaxValues();
                        int xStep = GetXStep(_TicksBounds.Height, minmax.Min, minmax.Max, _TicksStep);
                        int v = minmax.Min + (y / xStep) * _TicksStep;
                        if (v > this.Value.Max)
                            v = this.Value.Max;
                        if (v < minmax.Min)
                            v = minmax.Min;
                ...
                else if (_MouseDownPart == eRangeSliderPart.MaxRangeSlider)
                {
                    ...
                    else
                    {
                        int y = e.Y - (_TicksBounds.Y + this.Bounds.Y);
                        RangeValue minmax = GetNormalizedMinMaxValues();
                        int v = minmax.Min + (y / GetXStep(_TicksBounds.Height, minmax.Min, minmax.Max, _TicksStep)) * _TicksStep;
                        if (v < this.Value.Min)
                            v = this.Value.Min;
                        if (v > minmax.Max)
                            v = minmax.Max;
        ...
        {
            return string.Format(_RangeTooltipFormat, Value.Min, Value.Max);
        }
